...
import org.furion.core.bean.MonitorInfoBean;
...
public class MonitorComponent {
    ...
    private static double getCpuRateForLinux() {
        ...
        try {
            ...
            log.error("monitor cpuUsage error:", ioe);
    ...
    private static double getCpuRatioForMac() throws FurionException {
        ...
        if (StringUtils.isEmpty(cpuInfo)) {
            throw new FurionException("get cpu info error");
        }
