...
public final class FurionServiceLoader<S> implements Iterable<S> {
    ...
    public static <S> FurionServiceLoader<S> load(Class<S> service) {
        return FurionServiceLoader.load(service, Thread.currentThread().getContextClassLoader());
    }

    public static <S> FurionServiceLoader<S> load(Class<S> service, ClassLoader loader) {
        return new FurionServiceLoader<>(service, loader);
    }
    ...
    private FurionServiceLoader(Class<S> service, ClassLoader loader) {
