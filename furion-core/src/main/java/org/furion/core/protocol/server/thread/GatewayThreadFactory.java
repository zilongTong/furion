...
public class GatewayThreadFactory implements ThreadFactory {
    ...
    public GatewayThreadFactory(String prefix) {
        this(prefix, false);
    }

    public GatewayThreadFactory(String prefix, boolean isDaemon) {
        this(prefix, isDaemon, Thread.NORM_PRIORITY);
    }

    public GatewayThreadFactory(String prefix, boolean isDaemon, int priority) {
